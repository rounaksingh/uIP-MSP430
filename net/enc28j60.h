...
#define ENC28J60_CONTROL_SEL      P3SEL
#define ENC28J60_CONTROL_PORT     P3OUT
#define ENC28J60_CONTROL_DDR      P3DIR
#define ENC28J60_CONTROL_CS       BIT0
#define ENC28J60_CONTROL_MOSI     BIT1
#define ENC28J60_CONTROL_MISO     BIT2
#define ENC28J60_CONTROL_SCK      BIT3

// set CS to 0 = active
#define CSACTIVE ENC28J60_CONTROL_PORT&=~(ENC28J60_CONTROL_CS)
// set CS to 1 = passive
#define CSPASSIVE ENC28J60_CONTROL_PORT|=(ENC28J60_CONTROL_CS)
// wait to receive or send data from spi to enc28j60
#define waitspi() while (! (IFG2 & UCB0TXIFG))	
//spi write buffer
